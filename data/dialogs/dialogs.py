...
class Dialogs():
    ...
    def mod(self):
        ...
        if args.npc_dialog_tips:
            ...
            self.set_text(2986, "Practice Seed.<line>Leo: Add new characters<line>Airship Guy: Party management, equip members before battle.<line>Airship Controls: Final Kefka prompt.<line>Gehstahl: Go to boss room or back to airship.<line>In Boss Room, Daryl: Party Management.<line>In Boss Room, Rachel: HP/MP Restore.<end>")
